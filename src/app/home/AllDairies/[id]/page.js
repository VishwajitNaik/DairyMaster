                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr className="bg-gray-100">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.totalLiter}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.totalFat}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{user.totalSNF}</td>
                      </tr>
                    </tbody>
                  </table>
                ) : (
                  <p>No records found for this user in the selected date range.</p>
                )}
              </div>
            ))
          ) : (
